...
st.title("📊 多商品 RSI 策略分析儀表板（更新日期：2025/04/30）")
...
# 日期選擇器
start_date = st.sidebar.date_input("選擇開始日期", value=datetime(2023, 1, 1))
end_date = st.sidebar.date_input("選擇結束日期", value=datetime.today())
